...
from pipelines.pipeline_seesr_wStruct import StableDiffusionControlNetPipeline
...
def load_seesr_pipeline(args, accelerator, enable_xformers_memory_efficient_attention):
    ...
    from models.scheduling_ddpm import MyDDPMScheduler
    scheduler = MyDDPMScheduler.from_pretrained(args.pretrained_model_path, subfolder="scheduler")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lamda_psg", type=float, default=2)
    parser.add_argument("--lamda_rade", type=float, default=1)
    parser.add_argument("--alpha_ema", type=float, default=0.9)
